...
// ================= DEFAULT MOCK DATA =================
const DEFAULT_STAFF = [
    { id: 'st-admin', name: 'ดร.ณภัทร ปุญศิริ', nickname: 'แชมป์', position: 'ผู้จัดการ', email: 'nptconsultant2017@gmail.com', phone: '081-996-5444 , 089-113-8844', lineId: 'Champ0891138844', status: 'ว่าง' },
...
function initData() {
    ...
    if (!adminExists) {
        state.staff.unshift({
            ...
            phone: '081-996-5444 , 089-113-8844',
    ...
    if (needsPhoneLineMigration) {
        state.staff.forEach(s => {
            if (s.phone === undefined) {
                if (s.email === 'choochart@gmail.com') s.phone = '0811112222';
                else if (s.email === 'wanpen@gmail.com') s.phone = '0822223333';
                else if (s.email === 'prayut@gmail.com') s.phone = '0833334444';
                else if (s.email === 'tham@gmail.com') s.phone = '0837735828';
                else if (s.email === 'nptconsultant2017@gmail.com') s.phone = '081-996-5444 , 089-113-8844';
                else s.phone = '-';
            }
            if (s.lineId === undefined) {
                if (s.email === 'choochart@gmail.com') s.lineId = 'choochart.line';
                else if (s.email === 'wanpen@gmail.com') s.lineId = 'wanpen.line';
                else if (s.email === 'prayut@gmail.com') s.lineId = 'prayut.line';
                else if (s.email === 'tham@gmail.com') s.lineId = 'tham.line';
                else if (s.email === 'nptconsultant2017@gmail.com') s.lineId = 'Champ0891138844';
                else s.lineId = '-';
            }
        });
        saveDataToLocalStorage(false);
    ...
    if (needsNicknameMigration) {
        state.staff.forEach(s => {
            if (s.nickname === undefined) {
                if (s.email === 'choochart@gmail.com') s.nickname = 'ชาติ';
                else if (s.email === 'wanpen@gmail.com') s.nickname = 'เพ็ญ';
                else if (s.email === 'prayut@gmail.com') s.nickname = 'ยุทธ์';
                else if (s.email === 'tham@gmail.com') s.nickname = 'ธรรม';
                else if (s.email === 'nptconsultant2017@gmail.com') s.nickname = 'แชมป์';
                else s.nickname = '-';
            }
        });
        saveDataToLocalStorage(false);
...
window.editTask = function(id) {
    ...
    document.getElementById('task-notify-email').checked = false; // default false on edit to avoid spam
...
function setupEventListeners() {
    ...
    document.getElementById('btn-open-task-modal').addEventListener('click', () => {
        ...
        document.getElementById('task-notify-email').checked = true;
        openModal('task-modal');
    });
